...
const SearchResult = (props) => {
    ...
    // const [isMoreTrack, setIsMoreTrack] = useState(false);
    // const [isMoreAlbum, setIsMoreAlbum] = useState(false);
    // const [isMoreArtist, setIsMoreArtist] = useState(false);
    // const [isMorePlaylist, setIsMorePlaylist] = useState(false);

    // const [arrTrackTwoCard, setArrTrackTwoCard] = useState([]);
    // const [arrTrackThreeCard, setArrTrackThreeCard] = useState([]);
    // const [arrTrackFourCard, setArrTrackFourCard] = useState([]);
    // const [arrTrackFiveCard, setArrTrackFiveCard] = useState([]);
    // const [arrTrackSixCard, setArrTrackSixCard] = useState([]);
    // const [arrTrackSevenCard, setArrTrackSevenCard] = useState([]);
    ...
    // const [arrArtistTwoCard, setArrArtistTwoCard] = useState([]);
    // const [arrArtistThreeCard, setArrArtistThreeCard] = useState([]);
    // const [arrArtistFourCard, setArrArtistFourCard] = useState([]);
    // const [arrArtistFiveCard, setArrArtistFiveCard] = useState([]);
    // const [arrArtistSixCard, setArrArtistSixCard] = useState([]);
    // const [arrArtistSevenCard, setArrArtistSevenCard] = useState([]);
    const [arrArtistEightCard, setArrArtistEightCard] = useState([]);

    // const [arrPlaylistTwoCard, setArrPlaylistTwoCard] = useState([]);
    // const [arrPlaylistThreeCard, setArrPlaylistThreeCard] = useState([]);
    // const [arrPlaylistFourCard, setArrPlaylistFourCard] = useState([]);
    // const [arrPlaylistFiveCard, setArrPlaylistFiveCard] = useState([]);
    // const [arrPlaylistSixCard, setArrPlaylistSixCard] = useState([]);
    // const [arrPlaylistSevenCard, setArrPlaylistSevenCard] = useState([]);
    ...
    useEffect(() => {
        const queryTrack = async () => {
            ...
            // setArrTrackTwoCard([]);
            // setArrTrackThreeCard([]);
            // setArrTrackFourCard([]);
            // setArrTrackFiveCard([]);
            // setArrTrackSixCard([]);
            // setArrTrackSevenCard([]);
            ...
            // setArrArtistTwoCard([]);
            // setArrArtistThreeCard([]);
            // setArrArtistFourCard([]);
            // setArrArtistFiveCard([]);
            // setArrArtistSixCard([]);
            // setArrArtistSevenCard([]);
            setArrArtistEightCard([]);

            // setArrPlaylistTwoCard([]);
            // setArrPlaylistThreeCard([]);
            // setArrPlaylistFourCard([]);
            // setArrPlaylistFiveCard([]);
            // setArrPlaylistSixCard([]);
            // setArrPlaylistSevenCard([]);
            ...
            for (let i in track_list) {
                if (i < 3) {
                    ...
                    //         }
                    //     }]);
                    //     setArrTrackThreeCard(prev => [...prev, {
                    //         'track': {
                    //             'name': track_list[i].name,
                    //             'id': track_list[i].id,
                    //             'track_number': track_list[i].track_number - 1,
                    ...
                    //         }
                    //     }]);
                    //     setArrTrackSevenCard(prev => [...prev, {
                    //         'track': {
                    //             'name': track_list[i].name,
                    //             'id': track_list[i].id,
                    //             'track_number': track_list[i].track_number - 1,
            ...
            for (let i in artist_list) {
                ...
                //         'followers': artist_list[i].followers.total
                //     }]);
                //     setArrArtistThreeCard(prev => [...prev, {
                //         'artist': {
                //             'name': artist_list[i].name,
                //             'id': artist_list[i].id,
                //             'uri': artist_list[i].uri,
                ...
                //         'followers': artist_list[i].followers.total
                //     }]);
                //     setArrArtistFourCard(prev => [...prev, {
                //         'artist': {
                //             'name': artist_list[i].name,
                //             'id': artist_list[i].id,
                //             'uri': artist_list[i].uri,
                ...
                //         'followers': artist_list[i].followers.total
                //     }]);
                //     setArrArtistFiveCard(prev => [...prev, {
                //         'artist': {
                //             'name': artist_list[i].name,
                //             'id': artist_list[i].id,
                //             'uri': artist_list[i].uri,
                ...
                //         'followers': artist_list[i].followers.total
                //     }]);
                //     setArrArtistSevenCard(prev => [...prev, {
                //         'artist': {
                //             'name': artist_list[i].name,
                //             'id': artist_list[i].id,
                //             'uri': artist_list[i].uri,
            ...
            for (let i in playlist_list) {
                ...
                // if (i >= 0 && i < 2) {
                //     setMaxObtainPlaylist(parseInt(i) + 1);
                //     setArrPlaylistTwoCard(prev => [...prev, {
                //         'playlist': {
                //             'name': playlist_list[i].name,
                //             'id': playlist_list[i].id,
                //             'description': playlist_list[i].description,
                ...
                //         }
                //     }]);
                //     setArrPlaylistThreeCard(prev => [...prev, {
                //         'playlist': {
                //             'name': playlist_list[i].name,
                //             'id': playlist_list[i].id,
                //             'description': playlist_list[i].description,
                ...
                //         }
                //     }]);
                //     setArrPlaylistFourCard(prev => [...prev, {
                //         'playlist': {
                //             'name': playlist_list[i].name,
                //             'id': playlist_list[i].id,
                //             'description': playlist_list[i].description,
                ...
                //         }
                //     }]);
                //     setArrPlaylistFiveCard(prev => [...prev, {
                //         'playlist': {
                //             'name': playlist_list[i].name,
                //             'id': playlist_list[i].id,
                //             'description': playlist_list[i].description,
                ...
                //         }
                //     }]);
                //     setArrPlaylistSixCard(prev => [...prev, {
                //         'playlist': {
                //             'name': playlist_list[i].name,
                //             'id': playlist_list[i].id,
                //             'description': playlist_list[i].description,
                ...
                //         }
                //     }]);
                //     setArrPlaylistSevenCard(prev => [...prev, {
                //         'playlist': {
                //             'name': playlist_list[i].name,
                //             'id': playlist_list[i].id,
                //             'description': playlist_list[i].description,
